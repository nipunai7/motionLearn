...
import 'package:e_shop/PDF/utils.dart';
...
class PdfInvoiceApi {
  static Future<File> generate(Invoice invoice) async {
    ...
    return PdfApi.saveDocument(name: 'Motion_learn '+EcommerceApp.sharedPreferences.getString(EcommerceApp.latestOrder)+'.pdf', pdf: pdf);
  }
            ...
            children: [
              ...
              Container(
                ...
                child: BarcodeWidget(
                  ...
                  data: EcommerceApp.sharedPreferences.getString(EcommerceApp.latestOrder),
                ),
              ),
            ],
          ),
