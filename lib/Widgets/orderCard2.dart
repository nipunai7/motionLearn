...
class OrderCard2 extends StatelessWidget {
  ...
  OrderCard2({Key key, this.itemCount, this.data, this.orderID})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      //   if (counter == 0){
      //     counter = counter + 1;
      //     route = MaterialPageRoute(builder: (c) => ProductPage(itemModel:,));
      //   }
      ...
      child: Container(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (c, index) {
            ...
            return sourceInfo5(model, context);
          },
        ),
      ),
    );
...
Widget sourceInfo5(ItemModel model, BuildContext context, {Color background}) {
